...
---
```{r, echo = F}
HolzingerSwineford1939 <- read.csv2("KMKT/6praktikum/HolzingerSwineford1939.csv")
suur.viisik <- read.csv2("KMKT/6praktikum/suur.viisik.csv")
illness.cov <- read.csv2("KMKT/6praktikum/illness.cov.csv")
PoliticalDemocracy <- read.csv2("KMKT/6praktikum/PoliticalDemocracy.csv", sep =",")
```
