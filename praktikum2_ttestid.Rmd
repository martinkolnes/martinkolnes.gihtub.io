...
load("KMKT/2praktikum_ttest/ttest_andmed.RData")
```
...
## Kordamine  
Laadige andmestik [test11.csv](https://drive.google.com/open?id=1XEy50wRN3Vfe72jeTBD4jZGQhD6RmftT) RStudiosse.    
...
### Parameetriline  
Avage andmefail [test11](https://drive.google.com/open?id=1XEy50wRN3Vfe72jeTBD4jZGQhD6RmftT).    
...
### Mitteparameetriline  
Avage andmefail [koolid.csv](https://drive.google.com/open?id=1G55pBAz_mM3N0p7ahoQe_1HdmhCE1VN9).     
...
Avage andmefail [AUhinnangud.csv](https://drive.google.com/open?id=1nB7jHkb4sJ_lON3IDGIuuZ9UA-nP3v2z).  
...
### Parameetriline  
Avage andmefail [iqdata.csv](https://drive.google.com/open?id=150aWp-NakimASTd9EfwkphwW_Sd-se0X).  
